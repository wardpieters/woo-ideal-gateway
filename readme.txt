...
Tags: ideal, woocommerce, stripe, ideal betalen, ideal zonder kvk, ideal particulieren, payment gateway, ideal gateway, ecommerce, shopping, webshop
...
== Description ==
Payment gateway for WooCommerce that allows iDEAL via [Stripe](https://stripe.com/). This does not require a Chamber of commerce number!
...
= Updating =
Updates should work like a charm; as always though, ensure you backup your site just in case.
...
Then you click on 'Add Endpoint', in the field 'URL to be called' you fill in the URL stated in the settings of the plugin, e.g. https://voorbeeld.nl/?stripe_webhook=yes&key=EXAMPLE_PASSWORD.
...
= What about payments below the transactionfee? =
It is possible to do transactions below €0.45, but if you accept payments below that amount, you will lose money if you don't charge the customer for transactions.
